...
/* Add calls to plugins here */
  ...
  s.linkInternalFilters="greatwestlife.com,javascript:,mailto:,tel:"
...
/* For outboundlinktracking */
  var exc=document.URL; // custom added
  var exc1=exc.indexOf('eclaims-provider-listing.html'); // custom added
  //console.log("---here is mine--"+exc);
  
  if (s.linkType == "e" && exc1<0){
